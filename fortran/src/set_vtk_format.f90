...
﻿module set_vtk
  ...
  contains
!-------------------------------------------------------------------------------------------------------------------------------------
  function set_vtk_format(PrcTmp,output_path) 
    implicit none
    ...
    read(*,*) filetype
    if (filetype==1) then 
      function_value_int = set_AllInOne_vtk(PrcTmp,output_path)   
    ...
    !-------------------------------------------------------------------------------------------------------------------------------------
  function set_AllInOne_vtk(PrcTmp,output_path)
  implicit none
...
<<<<<<< HEAD
    do nx = 1 , PrcTmp%number_of_gridpoints(1)-1
      do ny = 1 , PrcTmp%number_of_gridpoints(2)-1
        nz = 1
        tempst =''
        ...
        write(1,'(a)',advance="no") trim(adjustl(tempst))//' '
        tempst =''
        write(tempst,*) PrcTmp%timestep(t)%node(nx,ny+1,nz)%vertex_index
        write(1,'(a)',advance="no") trim(adjustl(tempst))//' '
        tempst =''
...
>>>>>>> temp
  ...
  !-------------------------------------------------------------------------------------------------------------------------------------
<<<<<<< HEAD
  function set_x_vtk(PrcTmp,output_path) 
    implicit none
    integer :: set_x_vtk           
    type(PrcDataType) :: PrcTmp 
    ...
    do e = 1  ,  PrcTmp%number_of_elements
      do t = 1 , PrcTmp%number_of_timesteps
        ...
        enddo
!        
        SELECT CASE (PrcTmp%number_of_dimensions)
!          CASE (1)
          CASE (2)
            number_of_cells = (PrcTmp%number_of_gridpoints(1)-1)*(PrcTmp%number_of_gridpoints(2)-1)
            cell_list_size = number_of_cells * ((2**PrcTmp%number_of_dimensions)+1)
...
!!-------------------------------------------------------------------------------------------------------------------------------------
  function set_chp_vtk(PrcTmp,output_path)             
    implicit none
    integer :: set_chp_vtk           
    type(PrcDataType) :: PrcTmp 
    integer :: e,t,nx,ny,nz,number_of_points,number_of_cells, cell_list_size
...
!!-------------------------------------------------------------------------------------------------------------------------------------
  function set_phf_vtk(PrcTmp,output_path) 
    implicit none
    integer :: set_phf_vtk           
    type(PrcDataType) :: PrcTmp 
